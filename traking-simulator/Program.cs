...
class Program
{
    ...
    {
        // 🔥 NEW: Get vehicleId from command line
        ...
        while (true)
        {
            ...
            {
                carRunning = true;
                await SendCarStatus(client, vehicleId, "ON"); // 🔥 FIXED!
            ...
            while (carRunning)
            {
                try
                {
                    ...
                    var payload = JsonSerializer.Serialize(new
                    {
                        ...
                        // Removed status = "GPS_DATA" - not needed!
                    });
    ...
    // 🔥 UPDATED: Accept vehicleId parameter
