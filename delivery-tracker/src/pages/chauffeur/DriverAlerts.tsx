                ...
                <div className="flex items-center justify-between mb-6">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="">Notifications de l'administrateur</p>
                        </div>
                    </div>
                    {unreadCount > 0 && (
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm ">Total d'alertes</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                        ...
                        <CardContent className="p-4">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm ">Non lues</p>
                                </div>
                            </div>
                        </CardContent>
                    </Card>
                    ...
                    {filteredAlerts.length === 0 ? (
                        <Card className=" ">
                            <CardContent className="p-12 text-center">
                                ...
                                <p className=" text-lg">Aucune alerte à afficher</p>
                            </CardContent>
                        </Card>
                    ) : (
                        filteredAlerts.map((alert) => (
                            <Card
                                key={alert.id}
                                className={`  transition-all hover:shadow-lg ${alert.status === 'unread' ? 'border-l-4 border-l-blue-500' : ''
                                    }`}
                            >
                                            ...
                                            <div className="flex-1 space-y-3">
                                                ...
                                                <div className="grid md:grid-cols-2 gap-3">
                                                    ...
                                                    <div className="flex items-center gap-2 text-sm">
                                                        ...
                                                        <span className=" font-mono">{alert.deliveryId}</span>
                                                    </div>

                                                    <div className="flex items-center gap-2 text-sm md:col-span-2">
                                                        <MapPin className="w-4 h-4 text-gray-500" />
                                                        <span className="">Adresse:</span>
                                                        <span className="">{alert.address}</span>
                                                    </div>

                                                    <div className="flex items-center gap-2 text-sm">
                                                        <Clock className="w-4 h-4 text-gray-500" />
                                                        <span className="">{alert.timestamp}</span>
                                                    </div>
                                                </div>
