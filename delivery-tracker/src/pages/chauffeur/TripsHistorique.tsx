      ...
      <div className="max-w-7xl mx-auto">
        ...
        <Card className="mb-6 text-white">
          <CardHeader>
            ...
            <p className="text-gray-400">Tous vos trajets effectués avec succès</p>
          </CardHeader>
          <CardContent>
        ...
        <div className="space-y-6">
          {Object.entries(groupedTrips).map(([date, trips]) => (
            <Card key={date} className="bg-[#1a1a1a] border-gray-800">
              <CardHeader className="bg-green-500/10 border-b border-gray-800">
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  {trips.map((trip) => (
                    <Card
                      key={trip.id}
                      className={`border-l-4 border-l-green-500 transition-all hover:shadow-lg cursor-pointer bg-[#0f0f0f] border-gray-800 ${selectedTrip?.id === trip.id ? 'ring-2 ring-green-500' : ''
                        }`}
